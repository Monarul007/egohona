                        ...
                        <div class="app-page-title">
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div>eGohona Dashboard
                                        <div class="page-title-subheading">Welcome Back! <strong> <?= $result['name']; ?> </strong> Here you can view customer orders, manage customers order, change order status, add new product, add new product category, homepage slider, add user, manage users or customers and many more. Have fun!
                                        </div>
                                    </div>
                                </div>    
                            </div>
